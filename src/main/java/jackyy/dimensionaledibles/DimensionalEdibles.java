...
@Mod(modid = Reference.MODID, name = Reference.MODNAME, version = Reference.VERSION, acceptedMinecraftVersions = Reference.MCVERSION, dependencies = Reference.DEPENDS, guiFactory = Reference.GUIFACTORY, certificateFingerprint = "@FINGERPRINT@", useMetadata = true)
